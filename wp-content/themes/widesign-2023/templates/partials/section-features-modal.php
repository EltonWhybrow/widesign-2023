<div id="modal-features" class="modal h-screen flex fixed top-0 justify-center z-100 transform scale-0 transition-transform duration-300">
    ...
    <div class="md:w-10/12 lg:w-4/6 m-auto  bg-gray-100 text-gray-900 w-screen  h-screen sm:h-auto py-10 px-3 md:p-8">
        ...
        <header class="grid grid-cols-6 md:grid-cols-5 grid-flow-row gap-1 xl:gap-4 mx-auto mt-4">
            <h2 class="text-xl col-span-3 md:col-span-2 px-2 font-semibold text-gray-200 bg-plum-400">Plan features</h2>
            <p class="text-center border-l border-plum-600 text-xs md:text-sm lg:text-base">Starter</p>
            <p class="text-center border-l border-plum-600 text-xs md:text-sm lg:text-base">Advanced</p>
            <p class="text-center border-l border-plum-600 text-xs md:text-sm lg:text-base">
        ...
        <!-- <button class="close-modal bg-plum-500 inline-flex primary-btn my-2 mx-auto">Close</button> -->
    </div>
</div>