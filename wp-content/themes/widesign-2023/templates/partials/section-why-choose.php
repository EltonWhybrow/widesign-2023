<section class="flex flex-wrap md:flex-nowrap md:h-156">
    ...
    <div class="flex justify-center items-center bg-teal-700 w-full lg:w-2/5">
        <div class="px-4 md:px-10 py-10">
            ...
            <div class="flex justify-start space-x-4 mt-2"><a class="group inline-flex relative bg-teal-600 hover:bg-teal-500 pr-8 js-slidein primary-btn" href="/our-work">Our work<svg xmlns="http://www.w3.org/2000/svg" class="inline-block top-3 right-1 absolute ml-1 w-6 h-6 group-hover:rotate-360 transition-rotate duration-500 transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <a class="group inline-flex relative bg-teal-600 hover:bg-teal-500 pr-8 js-slidein-2 primary-btn" href="/services">Services<svg xmlns="http://www.w3.org/2000/svg" class="inline-block top-3 right-1 absolute ml-1 w-6 h-6 group-hover:rotate-360 transition-rotate duration-500 transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" />
                    </svg>
                </a>
            </div>
    ...
    <div class="relative py-0 w-full lg:w-3/5 h-100 md:h-auto object-cover">
        <div class="image-zoom">
            <div class="bg-whyus bg-left-top zoom-image"></div>
        </div>
    </div>
</section>