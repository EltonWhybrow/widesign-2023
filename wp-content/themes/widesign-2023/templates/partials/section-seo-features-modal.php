    ...
    <div class="md:w-10/12 lg:w-4/6 m-auto  bg-gray-100 text-gray-900 w-screen  h-screen sm:h-auto py-10 px-3 md:p-8">
        <div class="flex justify-end relative">
            <button type="button" class="close-modal focus:outline-none right-0 -top-7 md:-right-2 md:-top-3 absolute">
                <svg xmlns="http:www.w3.org/2000/svg" class="text-teal-600 h-10 md:h-6 w-10 md:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <header class="grid grid-cols-6 md:grid-cols-5 grid-flow-row gap-1 xl:gap-4 mx-auto mt-4">
            <h2 class="text-xl col-span-3 md:col-span-2 px-2 font-semibold text-gray-200 bg-teal-400">Plan features</h2>
            <p class="text-center border-l border-teal-600 text-xs md:text-sm lg:text-base">Starter</p>
            <p class="text-center border-l border-teal-600 text-xs md:text-sm lg:text-base">Advanced</p>
            <p class="text-center border-l border-teal-600 text-xs md:text-sm lg:text-base">
                <span class="hidden md:block">E-Commerce</span>
                <span class="md:hidden">E-Com</span>
            </p>
        </header>

        <div class="grid grid-cols-6 md:grid-cols-5 grid-flow-row gap-1 xl:gap-4 pb-10 mx-auto mt-2 max-h-11/12 md:max-h-100 overflow-scroll" style="-webkit-mask-image: linear-gradient(to bottom, black calc(100% - 65px), transparent 100%);">
            <!-- WEBDESIGN -->
            ...
            <!-- HOSTING & DOMAIN -->
            <div class="col-span-3 md:col-span-2">
                <h2 class="text-base">Hosting &amp; Domain name</h2>
                <p class="text-xs">We deploy and host your website to our secure UK servers once design and build are complete. All our packages include the first year of hosting and domain name FREE so you dont need to worry about additional costs.</p>
            </div>
            ...
            <p class="border-l border-teal-600 flex flex-col justify-center pl-1 md:pl-4"></p>
            <p class="border-l border-teal-600 flex flex-col justify-center pl-1 md:pl-4"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="text-success-900 h-8 w-8 mx-auto">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 01-1.043 3.296 3.745 3.745 0 01-3.296 1.043A3.745 3.745 0 0112 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 01-3.296-1.043 3.745 3.745 0 01-1.043-3.296A3.745 3.745 0 013 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 011.043-3.296 3.746 3.746 0 013.296-1.043A3.746 3.746 0 0112 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 013.296 1.043 3.746 3.746 0 011.043 3.296A3.745 3.745 0 0121 12z" />
                </svg>
            </p>
            ...
            <p class="border-l border-teal-600 flex flex-col justify-center text-center pl-1 md:pl-4">from £199</p>
            <p class="border-l border-teal-600 flex flex-col justify-center text-center pl-1 md:pl-4">from £199</p>
            <p class="border-l border-teal-600 flex flex-col justify-center text-center pl-1 md:pl-4">from £199</p>
            ...
            <p class="border-l border-teal-600 flex flex-col justify-center text-center pl-1 md:pl-4"><a class="primary-link text-teal-600 underline" href="/contact-us">Get in touch</a></p>
            <p class="border-l border-teal-600 flex flex-col justify-center text-center pl-1 md:pl-4"><a class="primary-link text-teal-600 underline" href="/contact-us">Get in touch</a></p>
            <p class="border-l border-teal-600 flex flex-col justify-center text-center pl-1 md:pl-4"><a class="primary-link text-teal-600 underline" href="/contact-us">Get in touch</a></p>

        </div>

        <!-- <button class="close-modal bg-teal-500 inline-flex primary-btn my-2 mx-auto">Close</button> -->
    </div>
</div>