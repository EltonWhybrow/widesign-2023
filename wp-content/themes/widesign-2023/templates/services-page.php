    ...
    <section id="tell-me-more" class="py-20 px-4 md:px-10 bg-teal-700 text-center">
        ...
        <div class="max-w-xl mx-auto py-3">
            <p class="text-gray-200">
                From story boarding and site planning to design and hosting. Your complete web design and development needs can be taken care of by our experienced team. We adhere to SEO best practices and web standards, whilst delivering fast, user-friendly websites, that stand out from the crowd.
            </p>
            <p class="text-gray-200">
        ...
        <div class="flex flex-wrap md:no-wrap justify-center mt-2 space-x-4">
            ...
            <div class="md:w-auto">
                <a class="js-slidein-2 relative inline-flex pr-8 primary-btn hover:bg-teal-500 bg-teal-600 group" href="/services/website-packages">
                    Website packages
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" stroke="none" stroke-width="2" class="absolute ml-1 top-3 right-1 inline-block transform group-hover:rotate-360 transition-rotate duration-500 w-6 h-6">
                        <path fill-rule="evenodd" d="M16.28 11.47a.75.75 0 010 1.06l-7.5 7.5a.75.75 0 01-1.06-1.06L14.69 12 7.72 5.03a.75.75 0 011.06-1.06l7.5 7.5z" clip-rule="evenodd" />
                    </svg>
