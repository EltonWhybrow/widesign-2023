...
<header class="sticky top-0 bg-gray-100 bg-opacity-90 z-75" style="width:100%;">
    ...
    <div class="xl:mx-auto flex justify-between px-5">

        <!-- Main Logo -->
        <div id="logo" routerLink="/" routerLinkActive="is-active" class="cursor-pointer h-28 w-28 block">
            <svg class="h-28 w-28" viewBox="0 10 100 80" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <!-- lg:hidden -->
        <!-- <div class="flex-none p-5 text-left  absolute right-0">
        ...
        <!-- NEW -->
        <div id="hamburger" class="hamburglar is-closed right-0 mr-5">
            ...
            <div class="burger-ring">
                <svg class="svg-ring">
                    <path class="path" fill="none" stroke="#2c7a7b" stroke-miterlimit="10" stroke-width="4" d="M 34 2 C 16.3 2 2 16.3 2 34 s 14.3 32 32 32 s 32 -14.3 32 -32 S 51.7 2 34 2" />
                </svg>
            </div>
